...
a persistence unit "EXAMENJaraRicardoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EXAMENJaraRicardo\pom.xml":
...
artifact ("EXAMENJaraRicardo.war") is already built. You can build
